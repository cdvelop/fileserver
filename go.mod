...
require (
	...
	github.com/cdvelop/fileinput v0.0.43
	github.com/cdvelop/maps v0.0.8
	github.com/cdvelop/model v0.0.86
	github.com/cdvelop/sqlite v0.0.85
...
require (
	github.com/cdvelop/api v0.0.74 // indirect
	...
	github.com/cdvelop/timeserver v0.0.28 // indirect
