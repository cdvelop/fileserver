...
require (
	github.com/cdvelop/api v0.0.60 // indirect
	...
	github.com/cdvelop/objectdb v0.0.84 // indirect
	github.com/cdvelop/output v0.0.16 // indirect
	github.com/cdvelop/timeserver v0.0.19 // indirect
...
require (
	...
	github.com/cdvelop/fileinput v0.0.31
