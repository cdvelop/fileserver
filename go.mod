...
require (
	...
	github.com/cdvelop/fileinput v0.0.53
	github.com/cdvelop/maps v0.0.8
	github.com/cdvelop/model v0.0.102
	github.com/cdvelop/sqlite v0.0.97
...
require (
	github.com/cdvelop/api v0.0.91 // indirect
	...
	github.com/cdvelop/objectdb v0.0.107 // indirect
